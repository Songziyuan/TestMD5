...
public class MainActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		testTextView3.setText("CPU架构是: " + getCPUArch());
		// 待加密
		String strText = "admin";
		TextView testTextView0 = (TextView)findViewById(R.id.testTextView0);
		testTextView0.setText("Content: \"" + strText + "\"");
		
		// java
		TextView testTextView1 = (TextView)findViewById(R.id.testTextView1);
		testTextView1.setText("MD5-java: " + getMD5(strText));
		
		// ndk c
		TextView testTextView2 = (TextView)findViewById(R.id.testTextView2);
		testTextView2.setText("MD5-ndk : " + encryptByMD5(strText));
